    ...
    describe('1', function() {
      ...
      describe('1.1', function() {
        ...
        it('1.1 test 1', function() {
          calls.push('1.1 test 1');
        });
        it('1.1 test 2', function() {
          calls.push('1.1 test 2');
        });
        afterEach(function() {
      ...
      describe('1.2', function() {
        ...
        it('1.2 test 1', function() {
          calls.push('1.2 test 1');
        });
        it('1.2 test 2', function() {
          calls.push('1.2 test 2');
        });
        afterEach(function() {
    ...
    describe('2', function() {
      ...
      describe('2.1', function() {
        ...
        it('2.1 test 1', function() {
          calls.push('2.1 test 1');
        });
        it('2.1 test 2', function() {
          calls.push('2.1 test 2');
        });
        afterEach(function() {
      ...
      describe('2.2', function() {
        ...
        it('2.2 test 1', function() {
          calls.push('2.2 test 1');
        });
        it('2.2 test 2', function() {
          calls.push('2.2 test 2');
        });
        afterEach(function() {
